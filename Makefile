# This Makefile is for the Net::Facebook::API extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Facebook/API.pm]
#     AUTHOR => q[root <root@localdomain>]
#     BUILD_REQUIRES => {  }
#     NAME => q[Net::Facebook::API]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/Facebook/API.pm]
...
MAKE = make
FULLEXT = Net/Facebook/API
BASEEXT = API
PARENT_NAME = Net::Facebook
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Facebook/API.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Net/Facebook
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Net/Facebook
...
TO_INST_PM = lib/Net/Facebook/API.pm

PM_TO_BLIB = lib/Net/Facebook/API.pm \
	blib/lib/Net/Facebook/API.pm
...
manifypods : pure_all  \
	lib/Net/Facebook/API.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/Facebook/API.pm $(INST_MAN3DIR)/Net::Facebook::API.$(MAN3EXT) 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Net/Facebook/API.pm blib/lib/Net/Facebook/API.pm 
